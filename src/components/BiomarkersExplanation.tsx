      ...
      <div className="container-custom px-4 sm:px-6">
        <div className="max-w-3xl mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-10 md:gap-12">
            <div className="bg-gray-50 p-8 md:p-10 rounded-2xl flex items-center justify-center flex-shrink-0">
              <Dna className="h-16 w-16 text-primary" />
            </div>
            
            <div>
              <h2 className="text-3xl font-bold mb-8">O que são biomarcadores?</h2>
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed max-w-[70ch]">
